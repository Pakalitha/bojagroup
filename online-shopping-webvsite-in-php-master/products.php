...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Boja-Botsheha-Group Spares!</h1>
                    <p>We have the best wheels, lights and engine for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/beyern-rapp-chrome-1.jpg" alt="Wheel">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wheel</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/236090-car-sport-Nissan-Nissan_GT-R-tires-rims.jpg" alt="GT R Tire rim">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>GT R Tire rim</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/PS8013_-_A_4035x.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Principal Engine</h3>
                                    <p>Price: M 50000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/backlight.jpg" alt="Backlight">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Back light</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sportlight.jpg" alt="Sport Light">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sport light</h3>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   ...
                   <p>This website is developed by Mr Kapoko</p>
               </center>
               </div>
           </footer>
        </div>
